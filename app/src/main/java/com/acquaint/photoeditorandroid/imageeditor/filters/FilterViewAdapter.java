package com.acquaint.photoeditorandroid.imageeditor.filters;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    public FilterViewAdapter(FilterListener filterListener,Context context,Bitmap bitmap) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      ...
      //  Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.flower);
        /*if(bitmap!=null){
            holder.mImageFilterView.getSource().setImageBitmap(bitmap);
        }
        else {
            holder.mImageFilterView.getSource().setImageResource(R.drawable.flower);
        }*/


       /* PhotoEditor mPhotoEditor = new PhotoEditor.Builder(context,  holder.mImageFilterView)
